...
export const emailMessage = (name) => {
  ...
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 0px 0px 0px;" bgcolor="323041" data-distribution="1">
  <tbody>
    <tr role="module-content">
      <td height="100%" valign="top"><table width="580" style="width:580px; border-spacing:0; border-collapse:collapse; margin:0px 10px 0px 10px;" cellpadding="0" cellspacing="0" align="left" border="0" bgcolor="323041" class="column column-0">
    <tbody>
      <tr>
  ...
  <tbody>
    <tr>
      <td style="padding:0px 0px 40px 0px;" role="module-content" bgcolor="323041">
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="323041">
      </td>
    </tr>
  </tbody>
  </table></td>
  ...
  <tbody>
    <tr>
      <td style="padding:18px 50px 18px 50px; line-height:22px; text-align:inherit; background-color:323041;" height="100%" valign="top" bgcolor="323041" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #A98A2E; font-size: 16px; font-family: inherit">Confirm your email address to start managing your finances on Fractal.</span></div><div></div></div></td>
    </tr>
  </tbody>
    ...
    <tbody>
      <tr>
        <td align="center" bgcolor="#dde6de" class="outer-td" style="padding:10px 0px 20px 0px; background-color:#323041;">
  ...
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:30px 0px 0px 0px;" bgcolor="323041" data-distribution="1">
  <tbody>
    <tr role="module-content">
  ...
  </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:40px 30px 30px 30px;" bgcolor="323041" data-distribution="1,1,1">
  <tbody>
    <tr role="module-content">
  ...
  <tbody>
    <tr>
      <td style="padding:40px 40px 40px 40px; line-height:22px; text-align:inherit; background-color:323041;" height="100%" valign="top" bgcolor="323041" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #A98A2E; font-size: 16px">Need more help figuring things out? Our support team is here to help!</span></div>
  <div style="font-family: inherit; text-align: center"><br></div>
  <div style="font-family: inherit; text-align: center"><a href="http://www.google.com"><span style="color: #A98A2E; font-size: 16px"><u>Help Center</u></span></a></div><div></div></div></td>
    </tr>
  </tbody>
